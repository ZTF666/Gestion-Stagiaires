        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                  ...
                  $Stag=$dao->loadStagiaires();
                 
                  foreach($Stag as $X)
                  {?>
                        <tr>
                       
                            <td><?php echo $X->cin ?></td>
                        <td><img class="img-circle" src='imgStagiaires/<?php echo $X->photo ?>'style="height:90px;width:90px" alt="User Image"></td>
                        <td><?php echo $X->nom." ".$X->prenom ?></td>
                        <td><?php echo $X->filiere ?></td>
                        <td><?php echo $X->ecole?></td>
                        <td><?php echo $X->tel?></td>
                        <td><?php echo $X->email?></td>
                          
                            <form method="post" action="ActionStagiaire.php">
