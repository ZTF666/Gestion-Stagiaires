...
-->
                  ...
                  ?>
                      <tr>
                        ...
                        <td><?php echo $X->cinEnc ?></td>
                        <td><?php echo $X->cinStag?></td>
                        <td><?php echo $X->Datedebut?></td>
                        <td><?php echo $X->Datefin?></td>
                          <td><?php if($X->Etat!=0){echo "Conclus";} ?></td>
<!--
                          <td><?php echo $X->Note ?></td>
                          <td><?php echo $X->Remarque ?></td>
-->
                          <form method="post" action="ActionArchiver.php">
                              <input type="hidden" value="<?php echo $X->IdSujet ?>" name="idsujet">  <!--ID sujet-->
                              <input type="hidden" value="<?php echo $X->cinEnc ?>" name="auteur">
                              <input type="hidden" value="<?php echo $X->Desg ?>" name="designation">
                     
                              <input type="hidden" value="<?php echo $X->Datefin ?>" name="fin">
                              <input type="hidden" value="<?php echo $X->Datedebut ?>" name="debut">
                        
                              
                             <input type="hidden" value="<?php echo $X->cinStag ?>" name="idstage">
                  

                              <td>
<!--                                  <button type="submit" class="btn btn-success" name="affecter">Noter</button>-->
                                  <button type="submit" class="btn btn-danger" onclick="return confirm('Voulez-vous  vraiment Archiver ce dossier ?')" name="Archiver">Archiver</button>
