                  ...
                  <div class="col-lg-6">
                    <div class="card">
                      <div class="card-header">
                        <strong>Ajouter</strong> stagiaire
                      </div>
                      <div class="card-body card-block">
                        <form action="Stagiaires-Edittraitement.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                              
                            <?php
                            $dao=new UDAO();
                            $ID=$_SESSION['IDSS'];
                            $infos=$dao->EditStagiaires($ID);
                            foreach($infos as $X){
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="cin" value="<?php echo $X->cin ?>" class="form-control"></div>
                          </div>
                            
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nom</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="nom" value="<?php echo $X->nom ?>" class="form-control"></div>
                          </div>
                             <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Prenom</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="prenom" value="<?php echo $X->prenom ?>" class="form-control"></div>
                          </div>
                            ...
                            <div class="col col-md-9">
                              <div class="form-check-inline form-check">
                                <label for="inline-radio1" class="form-check-label ">
                                  <input type="radio" id="inline-radio1" name="sexe" value="H" class="form-check-input">H
                                </label>
                                <label for="inline-radio2" class="form-check-label ">
                                  <input type="radio" id="inline-radio2" name="sexe" value="F" class="form-check-input">F
                                </label>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Date naissance</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="daten" value="<?php echo $X->daten ?>" class="form-control"></div>
                          </div>
                            <div class="row form-group">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="email" id="email-input" name="email" value="<?php echo $X->email ?>" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Telephone</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="tel" value="<?php echo $X->tel ?>" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Niveau scolaire</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="niveau" value="<?php echo $X->niveau ?>" class="form-control"></div>
                          </div>
                             <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Filiere</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="filiere" value="<?php echo $X->filiere ?>" class="form-control"></div>
                          </div>
                            <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Ecole</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="ecole" value="<?php echo $X->ecole ?>" class="form-control"></div>
                          </div>
