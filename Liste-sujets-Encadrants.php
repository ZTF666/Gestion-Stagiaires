        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                  ...
                  $sujet=$dao->loadMesSujets($user->cin);
                  ...
                  ?>
                      <tr>
                        ...
                        <td><?php echo $X->duree?></td>
                          <form method="post" action="ActionSujetEncadrant.php">
...
<!--                                  <button type="submit" class="btn btn-success" name="affecter">Affecter</button>-->
                                  <button type="submit" class="btn btn-danger" onclick="return confirm('Voulez-vous supprimer ce sujet ?')" name="DeleteEnc">Delete</button>
