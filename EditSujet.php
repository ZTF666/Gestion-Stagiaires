                  ...
                  <div class="col-lg-6">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action="Sujet-EditTraitement.php" method="post" enctype="multipart/form-data" class="form-horizontal">
    
                            <?php
                            $dao=new UDAO();
                            $ID=$_SESSION['IDS'];
                            $Sub=$dao->EditSujets($ID);
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="designation" value="<?php echo $X->designation ?>" class="form-control"></div>
                          </div>
                            
                             <div class="row form-group">
                            <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Description</label></div>
                            <div class="col-12 col-md-9"><textarea name="description" id="textarea-input" rows="9"  class="form-control"><?php echo $X->description ?></textarea></div>
                                 
                          </div>
                             <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Duré&eacute;</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="duree" value="<?php echo $X->duree ?>" class="form-control"></div>
                          </div>
