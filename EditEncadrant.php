...
<!--
                    ...
                    <li>
                        <a href="l"> <i class="menu-icon ti-email"></i>En attentes </a>
                    </li>
                     <li>
                  ...
                  <div class="col-lg-6">
                    <div class="card">
                      <div class="card-header">
                        <strong>Ajouter</strong> Encadrant
                      </div>
                      <div class="card-body card-block">
                        <form action="Encadrants-EditTraitement.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                            
                            <?php
                            $dao=new UDAO();
                            $ID=$_SESSION['ID'];
                            $infos=$dao->EditEncadrants($ID);
                            foreach($infos as $X){
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="file" id="file-input" name="photo" class="form-control-file" value="<?php echo $X->photo ?>"></div>
                          </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="log" value="<?php echo $X->log ?>" class="form-control"></div>
                          </div>
                            <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">mot de passe</label></div>
                            <div class="col-12 col-md-9"><input type="password" id="text-input" name="pwd" value="<?php echo $X->pwd ?>" class="form-control"></div>
                          </div>
                            <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">phrase/mot secret(e)</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="secret" value="<?php echo $X->qs ?>" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            ...
                            <div class="row form-group">
                            <div class="col col-md-3"><label for="select" class=" form-control-label">Departement</label></div>
