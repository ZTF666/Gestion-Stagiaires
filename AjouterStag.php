                  ...
                  <div class="col-lg-6">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action="Stagiaires-traitement.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Cin</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="cin" placeholder="Text" class="form-control"></div>
                          </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="prenom" placeholder="Text" class="form-control"></div>
                          </div>
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="daten" placeholder="Text" class="form-control"></div>
                          </div>
                            <div class="row form-group">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="tel" placeholder="Text" class="form-control"></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Niveau scolaire</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="niveau" placeholder="Text" class="form-control"></div>
                          </div>
                             <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Filiere</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="filiere" placeholder="Text" class="form-control"></div>
                          </div>
                            <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Ecole</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="ecole" placeholder="Text" class="form-control"></div>
                          </div>
