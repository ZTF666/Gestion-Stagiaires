            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                  ...
                  {?>
                        ...
                        <td><img class="img-circle" src='imgEncadrants/<?php echo $X->photo ?>'style="height:90px;width:90px" alt="User Image"></td>
                        <td><?php echo $X->nom." ".$X->prenom ?></td>
                        <td><?php echo $X->dept ?></td>
                        <td><?php echo $X->tel?></td>
                        <td><?php echo $X->email?></td>
                            <form method="post" action="ActionEncadrants.php">
