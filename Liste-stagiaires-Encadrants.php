                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                           <img class="user-avatar rounded-circle" src='imgEncadrants/<?php echo $user->photo ?>'style="height:60px;width:60px" alt="User Avatar">
                        </a>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                  ...
                  $Stag=$dao->LoadStageEncourEnc($user->cin);
                 
                  foreach($Stag as $X)
                  {?>
                        <tr>
                       
                            <td><?php echo $X->IdSujet ?></td>
                            <td><?php echo $X->cinStag ?></td>
                        <td><img class="img-circle" src='imgStagiaires/<?php echo $X->photoStag ?>'style="height:90px;width:90px" alt="User Image"></td>
                        <td><?php echo $X->nomStag." ".$X->prenomStag ?></td>
                        <td><?php echo $X->Desg ?></td>
                        <td><?php echo $X->Descr?></td>
                        <td><?php echo $X->Datedebut?></td>
                        <td><?php echo $X->Datefin?></td>
                          
                            <form method="post" action="ActionNoterStagiaire.php">
                        <input type="hidden" name="id" value="<?php echo $X->cinStag ?>">
                                <input type="hidden" name="ide" value="<?php echo $X->cinEnc ?>">
                          <td>
                             <button type="sumbit"  name="Noter"class="btn btn-success">Noter</button>
<!--
                              <input type="submit" value="Delete" name="Effacer" class="btn btn-danger" onclick="return confirm('Voulez-vous supprimer cette personne ?')">
                              <button type="submit" value="Edit" name="Modifier"  class="btn btn-info">EDIT</button>
-->
