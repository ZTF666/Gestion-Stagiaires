                  ...
                  <div class="col-lg-6">
                    <div class="card">
                      <div class="card-header">
                        <strong>Ajouter</strong> Sujet
                      </div>
                      <div class="card-body card-block">
                        <form action="Demande-Traitement.php" method="post" enctype="multipart/form-data" class="form-horizontal">
    
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Sujet</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="designation" placeholder="Text" class="form-control"></div>
                          </div>
...
<!--           TEST sur fichier                 -->
                          ...
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="file-input" class=" form-control-label">CV</label></div>
                            <div class="col-12 col-md-9"><input type="file" id="file-input" name="fichier" class="form-control-file"></div>
                          </div>
...
<!--           TEST sur fichier                 -->
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="duree" placeholder="Text" class="form-control"></div>
                          </div>
     
                            <div class="row form-group">
                            <div class="col col-md-3"><label for="select" class=" form-control-label">Proposé par :</label></div>
                            <div class="col-12 col-md-9">
                              <select name="auteur" id="select" class="form-control">
                                  <?php 
                            $dao=new UDAO();
                            $X=$dao->loadEncadrants();
                            foreach($X as $Enc){
                                    ?>
