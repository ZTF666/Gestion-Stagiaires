...
<!--                                -->
                               <?php  
                                ...
                                $result = mysql_query("select * from stagiaires S,sujet SJ,Encadrants E,Stage SG where S.cin=SG.idstagiaire and SJ.idSuj=SG.idsujet and E.cinEnc=SG.idencadrant and E.cinEnc=SJ.auteur and E.cinEnc='".$user->cin."' and SG.etat=0");  
...
<!--                                -->
 <?php  
                                $con = mysql_connect("localhost", "root", "");  
                                $selectdb = mysql_select_db("Gestionstagiaires",$con);  
                                $result = mysql_query("select * from sujet where auteur='".$user->cin."' ");  
                                $number_of_rows = mysql_num_rows($result);  
                                echo $number_of_rows;  
                                ?> 
<!--                            -->
                        ...
                        <p class="text-light">Mes sujets</p>
